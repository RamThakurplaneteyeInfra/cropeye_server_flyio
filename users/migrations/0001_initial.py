    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_phone_number', models.CharField(blank=True, help_text='Test phone number for this industry (for testing purposes)', max_length=15, null=True)),
                ('test_password', models.CharField(blank=True, help_text='Test password for this industry (for testing purposes)', max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, help_text='Phone number (10 digits for India). Optional.', max_length=15, null=True, unique=True)),
                ...
                ('industry', models.ForeignKey(blank=True, help_text='Industry this user belongs to. Null for Global Admin.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='users.industry')),
